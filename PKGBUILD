...
source_x86_64=("${_appimage}::https://download.todesktop.com/230313mzl4w4u92/cursor-0.44.6-build-2412214pmryneua-x86_64.AppImage" "cursor.png" "${pkgname}.desktop.in" "${pkgname}.sh")
noextract=("${_appimage}")
